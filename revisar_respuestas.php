...
if (!logged_in()) {
    ...
    $respuestas = obtenerRespuesta($_SESSION["userid"], $_GET["id"],$db);
            ...
            <div class="panel-body">
            	<?php
            		...
            		foreach ($respuestas as $key => $value) {
            			# code...
            			?>
            			 <h1> Problema <?php echo $index;?></h1>
            			 <h2> Tu Respuesta <?php echo $value['respuesta'];?></h2>
            			 <h2> La Respuesta <?php echo $preguntas[$index-1]['opcion_correcta'];?></h2>
            			 <p>
            			 <p>
            			<?php 
            			if( $value['respuesta'] == $preguntas[$index-1]['opcion_correcta']){
            				$correctas ++;
            			}
            			$index++;
            		}
            	?>
                <h1> Total de respuestas; <?php echo $correctas;?></h1>
                <?php
            ...
            <a href="javascript:void(0)" class="btn btn-primary btn-sm flip-der">
                ...
                <div class="panel panel-primary container-ch pan-der">
                    ...
                    <div class="panel-body">
                          ...
                          <a href="#" class="list-group-item" data-toggle="modal" data-target="#modalRespuesta">Verificar Respuestas
                            <i class="mdi-navigation-check pull-right"></i></a>
                    </div>
                </div>
        </div>
    </div>
